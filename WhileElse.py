...
##In this example, the loop will break if a 5 is generated, and the
## else will not execute. Otherwise, after 3 numbers are generated,
##the loop condition will become false and the else will execute.
